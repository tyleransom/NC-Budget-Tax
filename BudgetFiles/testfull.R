...
#Match <- matcher("vol62003", 84210, 54,842101, "total receipts",2,original=NULL)
#Match <- matcher("vol62003", 84210, 54,842101, "total receipts",1,4796080)
...
vol6tot <- rbind(cbind("Total Requirements",totreq),cbind("Total Receipts",totrec),netapp)
...
save(Map_finale1,file="Map_finale1.Rda")
save(Map_finale2,file="Map_finale2.Rda")
save(Map_finale3,file="Map_finale3.Rda")
save(Map_finale4,file="Map_finale4.Rda")
save(Map_finale5,file="Map_finale5.Rda")
save(Map_finale6,file="Map_finale6.Rda")

save(vol12003comb,file="vol12003comb.Rda")
save(vol22003comb,file="vol22003comb.Rda")
save(vol32003comb,file="vol32003comb.Rda")
save(vol42003comb,file="vol42003comb.Rda")
save(vol52003comb,file="vol52003comb.Rda")
save(vol62003comb,file="vol62003comb.Rda")

save(totsp,file="totsp.Rda")
save(netsp,file="netsp.Rda")