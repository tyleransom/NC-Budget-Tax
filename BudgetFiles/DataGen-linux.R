...
DataGen <- function(vol,year){
  ...
  if(year<10){
    V1 <- generator(as.character(paste(paste(year,"_",as.numeric(substr(year,4,4))+2,sep=""),"/vol",vol,".pdf",sep ="")))
  }
  else{
    V1 <- generator(as.character(paste(paste(year,"_",as.numeric(substr(year,3,4))+2,sep=""),"/vol",vol,".pdf",sep ="")))
  }
...
#################################################################################
  ...
  if(year<10){
    V2 <- generator2(as.character(paste(paste(year+1,"_",as.numeric(substr(year,4,4))+2,sep = ""),"/vol",vol,".pdf",sep="")))
  }
  else{V2 <- generator2(as.character(paste(paste(year+1,"_",as.numeric(substr(year,3,4))+2,sep = ""),"/vol",vol,".pdf",sep="")))}
#########################
 for (i in 1:nrow(V1)) {
